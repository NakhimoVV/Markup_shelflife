...
// let downboxLink = document.querySelector(".icon-Link");
// if (downboxLink != null) {
//     let delay = 500;
//     let downboxBody = document.querySelector(".downbox__body");
//     downboxLink.addEventListener("click", function (e) {
//         if (unlock) {
//             body_lock(delay);
//             iconMenu.classList.toggle("_active");
//             downboxBody.classList.toggle("_active");
//         }
//     });
// };
...
//     let downboxLink = document.querySelector(".icon-Link");
//     let downboxBody = document.querySelector(".downbox__body");
//     downboxLink.classList.remove("_active");
//     downboxBody.classList.remove("_active");
// }
